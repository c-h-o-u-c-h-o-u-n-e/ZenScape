        ...
        >
          {filtered.map(suggestion => (
            <button
              ...
              className="w-full text-left px-3 py-2.5 font-mono text-xs transition-colors duration-75 border-b border-ink-black/10 last:border-b-0 hover:bg-ink-black/8"
            >
              {suggestion}
            </button>
          ))}
